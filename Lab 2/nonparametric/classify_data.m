%
% classify_data(decision_grid, ML_)
%
...
% ML_: If true, select the maximum indices according to ML_ decision rule
%

function class_map = classify_data(decision_grid, ML_)

% ML_ parameter does not exist, so default it to false
if ~exist('ML_','var')
  ML_ = false;
end
