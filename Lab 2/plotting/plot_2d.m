...
plot_ellipse(m_hat_b_2(1),m_hat_b_2(2),theta_B,sqrt(eval_B(1,1)),sqrt(eval_B(2,2)),'r');
plot_ellipse(m_hat_c_2(1),m_hat_c_2(2),theta_C,sqrt(eval_C(1,1)),sqrt(eval_C(2,2)),'b');
