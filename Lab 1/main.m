...
figure
hold on
contour(case1_X,case1_Y,case1_GED,[0.5,0.5], 'LineColor', '#661010');
contour(case1_X,case1_Y,case1_MED,[0.5,0.5], 'LineColor', '#00ffdd');
contour(case1_X,case1_Y,case1_MAP,[0.5,0.5], 'LineColor', '#ff006f');
...
contour(case2_X,case2_Y,case2_MAP, [0.5,1.5], 'LineColor', '#ff006f');
